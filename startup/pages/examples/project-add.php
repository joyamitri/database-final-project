      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="project-conn.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <textarea type = "text" name = "project_desc" id="inputDescription" class="form-control" rows="4"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputClientCompany">Start Date</label>
                  <input type = "date" name = "start_date" id="inputClientCompany" class="form-control">
                </div>
                <div class="form-group">
                  <label for="inputProjectLeader">Project Leader Username</label>
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <form action="budget-conn.php" method="POST">
                <div class="form-group">
                  <label for="inputEstimatedBudget">Enter the Project Name</label>
                  <input type="text" id="inputEstimatedBudget" name="pr_name" class="form-control">
                </div>
                <div class="form-group">
                  <label for="inputSpentBudget">Estimated budget</label>
                  <input type="number" id="inputSpentBudget" name="budget" class="form-control">
                </div>
                <button type="submit" class="btn btn-primary float-right">Add Budget</button> 
              </form>
            </div>
            <!-- /.card-body -->
          </div>
