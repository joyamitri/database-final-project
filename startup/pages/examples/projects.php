          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="project-detail1.php">
                              <i class="fas fa-folder">
                              </i>
                              View
                          </a>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="project-detail2.php">
                              <i class="fas fa-folder">
                              </i>
                              View
                          </a>
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="project-detail3.php">
                              <i class="fas fa-folder">
                              </i>
                              View
                          </a>
