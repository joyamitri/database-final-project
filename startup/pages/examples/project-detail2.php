        ...
        <div class="card-body">
          <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0">5000</span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0">06-26-2022</span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              <h3 class="text-primary"><i class="fas fa-paint-brush"></i> Alternative Souk Al Akel</h3>
              <p class="text-muted">Souk Al Akel in Tripoli ma3 extra toum</p>
              <br>
              <div class="text-muted">
                <p class="text-sm">Project Leader
                  <b class="d-block">Rebeccadussy</b>
                </p>
              </div>
            </div>
          </div>
