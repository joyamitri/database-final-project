...
if($num == 1) {
	...
	if($counter == 1){
		...
		while($row=mysqli_fetch_row($res)){
			...
			$query="INSERT INTO `users`(`first_name`, `last_name`, `username`, `email`, `password`, `companies_id`, `user_types_id`) VALUES ('$first_name','$last_name','$username','$email','$hash',$row[0], 2)";
